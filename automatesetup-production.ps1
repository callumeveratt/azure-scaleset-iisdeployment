...
$getdomainPassword = Invoke-RestMethod -Uri https://UKS-SPM-KV-DEPLOY.vault.azure.net/secrets/applicationPoolPassword?api-version=2016-10-01 -Method GET -Headers @{Authorization="Bearer $keyVaultToken"}
$domainPassword = $getdomainPassword.value

$domain = "selenityazure.com"
$username =  "selenityazure\apppool-production"
