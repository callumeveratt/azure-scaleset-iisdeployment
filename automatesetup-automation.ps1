...
$getdomainPassword = Invoke-RestMethod -Uri https://UKS-SPMT-AUT-KV-DEPLOY.vault.azure.net/secrets/applicationPoolPassword?api-version=2016-10-01 -Method GET -Headers @{Authorization="Bearer $keyVaultToken"}
